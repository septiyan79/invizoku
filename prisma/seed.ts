  ...
  const themes = [
    {
      ...
      event_categories: ['wedding', 'tunangan'],
      style_tag: 'elegan',
    ...
    {
      name: 'Wedding Rustic',
      event_categories: ['wedding'],
      style_tag: 'tradisional-adat',
      type: 'standard' as const,
    ...
    {
      name: 'Aqiqah Sakura',
      event_categories: ['aqiqah', 'khitan'],
      style_tag: 'floral',
      type: 'standard' as const,
